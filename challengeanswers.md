...
**_Nota: Utilizaremos os seguintes critérios para a avaliação: Desempenho, Testes, Manutenabilidade e boas práticas de engenharia de software._**
...
**_Nota: Você pode utilizar o scaffold disponibilizado no diretório "shipay-react-app" ou sugerir uma estrutura mais adequada. O que achar melhor._**
...
O estado inicial pode estare vindo nulo ou há um erro ou falha na api que recebe essas propriedades.
